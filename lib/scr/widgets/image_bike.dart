...
import 'package:Daplieh/scr/screens/details_bike.dart';

class BikeCard extends StatelessWidget {
  String model,costPhour,costPday,bid,keyid;
  var image;
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: InkWell(
        onTap: (){
          Navigator.push(context, MaterialPageRoute(builder: (_)=> DetailBike(bike)));
        },
        child: Container(
